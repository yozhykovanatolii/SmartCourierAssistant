...
class RouteRepository {
  ...
  Future<String> getRouteRecommendationByAI(
    ...
    List<OrderModel> ordersModel = ordersEntity
        .map((order) => OrderMapper.fromEntity(order))
        .toList();
    ordersModel = ordersModel
        ...
        .toList();
    final riskyOrders = ordersModel
        .map((orderModel) => RiskyOrderModel.fromOrderModel(orderModel))
        .toList();
    ...
    await _routeFirestore.saveRouteRecommendation(
      recommendation ?? '',
      routeId ?? '',
    );
